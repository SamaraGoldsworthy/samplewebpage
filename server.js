...
app.get("/lesson4", (request, response) => {
  response.sendFile(__dirname + "/views/lesson4.html");
});
app.get("/mariopy", (request, response) => {
  response.sendFile(__dirname + "/views/mariopy.html");
});
